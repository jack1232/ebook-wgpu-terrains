...
impl State {
    async fn new(window: &Window, sample_count: u32, width: u32, height: u32) -> Self {
        ...
        let mut terrain = terrain_data::ITerrain {
            scale: 40.0,
            water_level: 0.3,
            width,
            height,
        ...
        let vertex_data = terrain.create_terrain_data_chunk();
        ...
        let camera_position = (250.0, 300.0, 300.0).into();
    ...
    fn update(&mut self) {
        ...
        if self.update_buffers {
            let vertex_data = self.terrain.create_terrain_data_chunk();
            self.init
                .queue
    ...
    fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
...

        {
            ...
            if plot_type == "shape_only" || plot_type == "both" {
                ...
                render_pass.draw_indexed(0..self.indices_lens[0], 0, 0..CHUNKS_COUNT);
            }
            ...
            if plot_type == "wireframe_only" || plot_type == "both" {
                ...
                render_pass.draw_indexed(0..self.indices_lens[1], 0, 0..CHUNKS_COUNT);
            }
        }
...
fn main() {
    ...
    let window = winit::window::WindowBuilder::new()
        .build(&event_loop)
        .unwrap();
    window.set_title(&*format!("{}", "terrain_instance"));
